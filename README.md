...
- [Live Demo Link](https://supreeti.github.io/ToDoList/dist)
  Visit my project.
...
```sh
  cd my-folder
  git clone https://github.com/supreeti/ToDoList.git
```
### Install
...
Feel free to check the [issues page](https://github.com/supreeti/ToDoList/issues/new).
...
This project is [MIT](https://github.com/supreeti/ToDoList/blob/main/LICENSE) licensed.
<p align="right">(<a href="#readme-top">back to top</a>)</p>
